...
validate.classificationRule = () => {
  return [
    ...
    body("classification_name")
      .trim()
      .isLength({ min: 1 }).withMessage("Provide appropriate field legth.")
      // .isAlpha().withMessage("Provide a correct classification name.")
      .matches(/^[A-Z][A-Za-z]*$/).withMessage("Must start with a capital letter and contain only letters (no spaces, numbers, or special characters).")
      ,
  ]
}
...
// Error will be directed to Edit Inventory view
